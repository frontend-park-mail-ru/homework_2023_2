...
/* Return the type of input expression, validating roman and int numbers
*
...
* @returns {string|number}  returns a number if the input expression is a Roman number, and returns a string if the input expression is an int number
*/
function roman (s) {
   ...
   throw new Error(`Your number ${String(s)} is incorrect or it is not a number!`);
}
